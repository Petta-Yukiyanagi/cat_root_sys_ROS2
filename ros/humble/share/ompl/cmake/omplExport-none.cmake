...
set_target_properties(ompl::ompl PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libompl.so.1.7.0"
  IMPORTED_SONAME_NONE "libompl.so.18"
  )

list(APPEND _IMPORT_CHECK_TARGETS ompl::ompl )
list(APPEND _IMPORT_CHECK_FILES_FOR_ompl::ompl "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libompl.so.1.7.0" )
