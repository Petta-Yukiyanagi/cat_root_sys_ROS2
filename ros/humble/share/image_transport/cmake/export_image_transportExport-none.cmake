...
set_target_properties(image_transport::image_transport PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libimage_transport.so"
  IMPORTED_SONAME_NONE "libimage_transport.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS image_transport::image_transport )
list(APPEND _IMPORT_CHECK_FILES_FOR_image_transport::image_transport "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libimage_transport.so" )
