...
struct ProjectedMapsInfo_Request_
{
  ...
  using _projected_maps_info_type =
    std::vector<map_msgs::msg::ProjectedMapInfo_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<map_msgs::msg::ProjectedMapInfo_<ContainerAllocator>>>;
  _projected_maps_info_type projected_maps_info;

  // setters for named parameter idiom
  Type & set__projected_maps_info(
    const std::vector<map_msgs::msg::ProjectedMapInfo_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<map_msgs::msg::ProjectedMapInfo_<ContainerAllocator>>> & _arg)
  {
