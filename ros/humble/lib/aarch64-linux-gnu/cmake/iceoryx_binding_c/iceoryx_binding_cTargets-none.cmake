...
set_target_properties(iceoryx_binding_c::iceoryx_binding_c PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_binding_c.so"
  IMPORTED_SONAME_NONE "libiceoryx_binding_c.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iceoryx_binding_c::iceoryx_binding_c )
list(APPEND _IMPORT_CHECK_FILES_FOR_iceoryx_binding_c::iceoryx_binding_c "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_binding_c.so" )
