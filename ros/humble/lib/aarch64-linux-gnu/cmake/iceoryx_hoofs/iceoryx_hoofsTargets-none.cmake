...
set_target_properties(iceoryx_hoofs::iceoryx_hoofs PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_hoofs.so"
  IMPORTED_SONAME_NONE "libiceoryx_hoofs.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iceoryx_hoofs::iceoryx_hoofs )
list(APPEND _IMPORT_CHECK_FILES_FOR_iceoryx_hoofs::iceoryx_hoofs "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_hoofs.so" )
...
set_target_properties(iceoryx_hoofs::iceoryx_platform PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_platform.so"
  IMPORTED_SONAME_NONE "libiceoryx_platform.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iceoryx_hoofs::iceoryx_platform )
list(APPEND _IMPORT_CHECK_FILES_FOR_iceoryx_hoofs::iceoryx_platform "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_platform.so" )
