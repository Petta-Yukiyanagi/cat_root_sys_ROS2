...
set_target_properties(iceoryx_posh::iceoryx_posh PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh.so"
  IMPORTED_SONAME_NONE "libiceoryx_posh.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iceoryx_posh::iceoryx_posh )
list(APPEND _IMPORT_CHECK_FILES_FOR_iceoryx_posh::iceoryx_posh "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh.so" )
...
set_target_properties(iceoryx_posh::iceoryx_posh_roudi PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh_roudi.so"
  IMPORTED_SONAME_NONE "libiceoryx_posh_roudi.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iceoryx_posh::iceoryx_posh_roudi )
list(APPEND _IMPORT_CHECK_FILES_FOR_iceoryx_posh::iceoryx_posh_roudi "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh_roudi.so" )
...
set_target_properties(iceoryx_posh::iceoryx_posh_gateway PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh_gateway.so"
  IMPORTED_SONAME_NONE "libiceoryx_posh_gateway.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iceoryx_posh::iceoryx_posh_gateway )
list(APPEND _IMPORT_CHECK_FILES_FOR_iceoryx_posh::iceoryx_posh_gateway "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh_gateway.so" )
...
set_target_properties(iceoryx_posh::iceoryx_posh_config PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh_config.so"
  IMPORTED_SONAME_NONE "libiceoryx_posh_config.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS iceoryx_posh::iceoryx_posh_config )
list(APPEND _IMPORT_CHECK_FILES_FOR_iceoryx_posh::iceoryx_posh_config "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libiceoryx_posh_config.so" )
