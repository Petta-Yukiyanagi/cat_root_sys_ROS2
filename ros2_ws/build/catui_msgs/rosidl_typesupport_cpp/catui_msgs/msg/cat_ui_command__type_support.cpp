...
static const _CatUICommand_type_support_symbol_names_t _CatUICommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, catui_msgs, msg, CatUICommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, catui_msgs, msg, CatUICommand)),
  }
};
...
{
  return &::catui_msgs::msg::rosidl_typesupport_cpp::CatUICommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, catui_msgs, msg, CatUICommand)() {
  return get_message_type_support_handle<catui_msgs::msg::CatUICommand>();
}
