...
: ${AMENT_CURRENT_PREFIX:="/opt/cat_robot/src/ros2_ws/install/self_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/self_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/self_test/environment/path.sh"
