...
foreach(_cmake_expected_target IN ITEMS joy::game_controller)
...
# Create imported target joy::game_controller
add_library(joy::game_controller SHARED IMPORTED)

set_target_properties(joy::game_controller PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/joy"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/export_game_controllerExport-*.cmake")
